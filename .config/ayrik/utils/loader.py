...
from vars import HOME, AYRIK_DIR, GTK2_CFG, GTK3_CFG, GTK4_CFG    
...
theme_options: List[BaseOption] = [
    ...
    CopyOption(_id="micro", name="theme.micro", path_to=HOME / ".config" / "micro" / "colorschemes" / "ayrik.micro"),
    ...
    CopyOrGenOption(
        ...
        path_to=HOME / ".config" / "qt5ct" / "colors" / "ayrik.conf",
        template_name="qt5ct-colors.mustache"
    ),
    CopyOrGenOption(
        _id="qt6ct",
        name="qt6ct-colors.conf",
        path_to=HOME / ".config" / "qt6ct" / "colors" / "ayrik.conf",
    ...
    KittyOption(
        _id="kitty",
        name="kitty.conf",
        path_to=HOME / ".config" / "kitty" / "theme" / "theme.conf",
